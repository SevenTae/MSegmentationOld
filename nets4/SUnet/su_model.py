from nets4.SUnet.su_part import *
...
class SUNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        # self.midchanel = [24, 48, 96, 192, 1024 ]
        #[24, 116, 232, 464, 1024 （1.0的]
        self.attention =CBAM_ECAAttention(channel=192)

        self.cg1= ContextGuidedBlock(nIn=48,nOut=48,reduction=8)
        self.cg2= ContextGuidedBlock(nIn=96,nOut=96,reduction=8)
