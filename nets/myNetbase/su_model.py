...
from nets.myNetbase.su_part2 import *
from torch import  nn
from  nets.myNetbase.shufflenet_d import shufflenet_v2_x1_0
import torch
...
class SUNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.attention4  = sa_layer(channel=464,groups=8)
    ...
    def forward(self, input):
        ...
        #24(256),24(128)  116(64), 232(32), 464(16)(反过来的)
