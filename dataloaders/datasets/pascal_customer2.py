...
class Customer_VOCSegmentation(Dataset):
    ...
    def __init__(self,
        ...
        for splt in self.split:
            ...
            for ii, line in enumerate(lines):
                _image = os.path.join(self._image_dir, line + ".tif") #注意这个地方有的图片可能是jpg有的可能是png自己看着改
                _cat = os.path.join(self._cat_dir, line + ".tif")  #注意格式
    ...
    def transform_tr(self, sample):
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.214, 0.288, 0.229), std=(0.079, 0.076, 0.056)),#针对tree数据集的
            # tr.Normalize_simple(),
            tr.ToTensor()])
    ...
    def AugTrain(self, sample):
        composed_transforms = transforms.Compose([
            ...
            # tr.Normalize_simple(),
            tr.Normalize(mean=(0.214, 0.288, 0.229), std=(0.079, 0.076, 0.056)),
            tr.ToTensor()])
        return composed_transforms(sample)
