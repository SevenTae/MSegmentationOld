...
from utils.evaluate_train_module import  evaluateloss ,evalue_iou_miou
...
#
'''你之前的miou计算方法错了 霹雳巴拉和人家buling他俩算出来的一样 就你离谱'''
# 加了tensorboard记录
...
def train_net(net,
    ...
    # (Initialize logging)
    experiment = wandb.init(project='Sunet01', resume='allow', anonymous='must')
