...
if __name__ == '__main__':
    ...
    from netCompaire.unet.unet_model import UNet, weights_init
    ...
    model_path = r"F:\MyReSegmet\compaCustome2\unet\checkpoints\best.pth"
    model_dict = torch.load(model_path)
    model = UNet(n_channels=3, n_classes=13)
